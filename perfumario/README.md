...
**Doce ya traen la foto real en el build**, cargadas con
...
resultado. **Las originales no entran al repo**: 8 MB de fotos de cámara
quedaron en 118 KB adentro del build, que es lo único que la app necesita para
mostrarlas en 44 px.
